...
function fpdf($orientation='P',$unit='mm',$format='A4')
{
	...
	if(is_string($format))
	{
		...
		elseif($format=='kwt_baru')
			$format=array(340.16,411.03);
		elseif($format=='kwt_kartu')
			$format=array(155.91,240.95);
		elseif($format=='kwt_antrian')
			$format=array(215.43,255.12);
...
function Image2($file,$x,$y,$w=0,$h=0,$type='',$link='',$paint=true)
{
	//Put an image on the page
	if(!isset($this->images[$file]))
	{
