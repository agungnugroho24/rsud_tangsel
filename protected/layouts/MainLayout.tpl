...
<div class="ui-layout-west">
    ...
    <div class="ui-layout-west-content">
        ...
        <div id="accordionMenu">
            ...
            <com:TControl ID="rekamMedisCtrl2">
            <div>
                <h3><a href="#">Admin Rawat Jalan</a></h3>
                <div>
                	<span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Admin Rawat Jalan" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Pendaftaran.AdminRwtJln') %>" Attributes.onclick="maskContent()"/>
                    <span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Admin Rawat Jalan Edit" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Pendaftaran.AdminRwtJlnEdit') %>" Attributes.onclick="maskContent()"/>
                </div>
            ...
            <div>
                ...
                <div>
					<span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Pembuatan Resep Rawat Inap" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Rawat.PembuatanResepInap') %>" Attributes.onclick="maskContent()"/>
            ...
            <div>
                ...
                <div>
                    <span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Pengambilan Resep Rawat Jalan" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Apotik.pengambilanResep') %>" Attributes.onclick="maskContent()"/>
					<span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Pengambilan Resep Rawat Inap" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Apotik.pengambilanResepInap') %>" Attributes.onclick="maskContent()"/>
            ...
            <div>
                ...
                <div>
                    ...
                    <span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Pengeluaran BHP" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Farmasi.PengeluaranBhp') %>" Attributes.onclick="maskContent()"/>
                    
                    <span style="display:none" class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Pengadaan Barang Radiologi" Visible="false" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Rad.FilmBeli') %>" Attributes.onclick="maskContent()"/>
                    <span style="display:none" class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Visible="false" Text="Penerimaan Barang Radiologi" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Rad.FilmMasuk') %>" Attributes.onclick="maskContent()"/>
                    <span style="display:none" class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Info Stok Barang Radiologi" Visible="false" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Rad.MasterStokFilm') %>" Attributes.onclick="maskContent()"/>
                </div>
            </div>
            </com:TControl>
            
            <com:TControl ID="fisioCtrl">
            <div>
                <h3><a href="#">Elektromedik</a></h3>
                <div>
                    <span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Rekam Billing Elektromedik" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Fisio.bayarFisio') %>" Attributes.onclick="maskContent()"/>
                    <span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Laporan Transaksi" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Fisio.LapTrans') %>" Attributes.onclick="maskContent()"/>
                </div>
            </div>
            </com:TControl>
            
            <com:TControl ID="CtScanCtrl">
            <div>
                <h3><a href="#">CT Scan</a></h3>
                <div>
                    <span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Rekam Billing CT Scan" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('CtScan.bayarCtScan') %>" Attributes.onclick="maskContent()"/>
                    <span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Rekam Analisa Foto" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('CtScan.beritaCtScan') %>" Attributes.onclick="maskContent()"/>
                    <span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Pengambilan Hasil Foto" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('CtScan.ambilHasilCtScan') %>" Attributes.onclick="maskContent()"/>
                    <span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Laporan Transaksi" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('CtScan.LapTrans') %>" Attributes.onclick="maskContent()"/>
                </div>
            </div>
            </com:TControl>
            ...
            <div>
                ...
                <div>
                    <span class="ui-icon ui-icon-carat-1-e"></span><com:TActiveHyperLink Text="Lap. Penerimaan Poli" CssClass="menu-kiri" NavigateUrl="<%= $this->Service->constructUrl('Tarif.LapPenerimaanPoli') %>" Attributes.onclick="maskContent()"/>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
    	<tr>
        	<td width="40%" style="padding-left:10px;">
            	<marquee scrolldelay="180"><strong>PEMERINTAH KOTA TANGERANG SELATAN</strong> - JL. Surya Kencana No. 1 Pamulang Telp. (021) 7404752 &nbsp;&nbsp; &copy; Copyright of Intergo Telematics 2003 - <%= date('Y') %> </marquee>
            </td>
