<?php
class KasirLabBaru extends SimakConf
{   
	...
	{				
		...
		{			
			...
			$this->Response->redirect($this->Service->constructUrl('Tarif.KasirLab',array('goto'=>'1')));
	...
	*/
    ...
    {	
		...
		if($jnsRujukan == '0')
		{
			if($asalPasien == '0') //Pasien Rawat Jalan
			{
				$sql="UPDATE tbt_lab_penjualan SET flag='1' WHERE no_trans='$notrans' AND cm='$cm' AND flag='0' ";
			}
			elseif($asalPasien == '1') //Pasien Rawat Inap
			{
				$sql="UPDATE tbt_lab_penjualan_inap SET flag='1' WHERE no_trans='$notrans' AND cm='$cm' AND flag='0' ";
			}
		}	
		elseif($jnsRujukan == '1')
		{
			$sql="UPDATE tbt_lab_penjualan_lain SET flag='1' WHERE no_trans='$notrans' AND flag='0' ";
		}
		...
		$this->Response->redirect($this->Service->constructUrl('Tarif.cetakNotaLab',array('notrans'=>$notrans,'cm'=>$cm,'nama'=>$nama,'jmlTagihan'=>$jmlTagihan,'jnsRujukan'=>$jnsRujukan,'asalPasien'=>$asalPasien,'petugasLab'=>$this->getViewState('petugasLab'))));
