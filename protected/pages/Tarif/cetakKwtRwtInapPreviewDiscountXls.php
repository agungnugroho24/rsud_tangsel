<?php
class cetakKwtRwtInapPreviewDiscountXls extends XlsGen
{
	...
	{	
		...
		$file = 'PreviewKwtRawatInap-'.$notrans.'.xls';
		...
		{	
			...
			foreach($arr as $row)
			{
				if($row['operator'] > 0)
				{
					$worksheet1->write_string($baris,$kolom,'Operator',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,PegawaiRecord::finder()->findByPk($row['dktr_obgyn'])->nama,$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,'Rp. '.number_format($row['operator'],2,',','.'),$frmtRightBorder); $kolom++;
					$worksheet1->merge_cells($baris, 0, $baris, 2); 
					$worksheet1->merge_cells($baris, 3, $baris, 4); 
					$baris++; $kolom = 0;
				}
				...
				if($row['anastesi'] > 0)
				{
					$worksheet1->write_string($baris,$kolom,'Dokter Anastesi',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,PegawaiRecord::finder()->findByPk($row['dktr_anastesi'])->nama,$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,'Rp. '.number_format($row['anastesi'],2,',','.'),$frmtRightBorder); $kolom++;
					$worksheet1->merge_cells($baris, 0, $baris, 2); 
					$worksheet1->merge_cells($baris, 3, $baris, 4); 
					$baris++; $kolom = 0;
				}
				...
				if($row['resusitasi'] > 0)
				{
					$worksheet1->write_string($baris,$kolom,'Resusitasi Sp. Anak',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,PegawaiRecord::finder()->findByPk($row['dktr_resusitasi'])->nama,$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,'Rp. '.number_format($row['resusitasi'],2,',','.'),$frmtRightBorder); $kolom++;
					$worksheet1->merge_cells($baris, 0, $baris, 2); 
					$worksheet1->merge_cells($baris, 3, $baris, 4); 
					$baris++; $kolom = 0;
				}
				...
				{
					$worksheet1->write_string($baris,$kolom,'Penata Anastesi',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,PegawaiRecord::finder()->findByPk($row['dktr_anak'])->nama,$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,'Rp. '.number_format($row['ast_anastesi'],2,',','.'),$frmtRightBorder); $kolom++;
					$worksheet1->merge_cells($baris, 0, $baris, 2); 
					$worksheet1->merge_cells($baris, 3, $baris, 4); 
					$baris++; $kolom = 0;
				}
				...
				{
					$worksheet1->write_string($baris,$kolom,'Asst. Operator',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,PegawaiRecord::finder()->findByPk($row['ass_dktr'])->nama,$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,'Rp. '.number_format($row['ast_operator'],2,',','.'),$frmtRightBorder); $kolom++;
					$worksheet1->merge_cells($baris, 0, $baris, 2); 
					$worksheet1->merge_cells($baris, 3, $baris, 4); 
					$baris++; $kolom = 0;
				}
				...
				{
					$worksheet1->write_string($baris,$kolom,'Paramedis',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,PegawaiRecord::finder()->findByPk($row['paramedis'])->nama,$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
					$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
					$worksheet1->write_string($baris,$kolom,'Rp. '.number_format($row['tarif_paramedis'],2,',','.'),$frmtRightBorder); $kolom++;
					$worksheet1->merge_cells($baris, 0, $baris, 2); 
					$worksheet1->merge_cells($baris, 3, $baris, 4); 
					$baris++; $kolom = 0;
				}
		...
		{	
			...
			{				
				...
				$worksheet1->write_string($baris,$kolom,$row['nama_kamar'],$frmtLeftBorder);  $kolom++;
				$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
				$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder); $kolom++;
				$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
				$worksheet1->write_string($baris,$kolom,'',$frmtLeftBorder);  $kolom++;
				$worksheet1->write_string($baris,$kolom,$lamaInapBayi.' Hari',$frmtLeftBorder); $kolom++;
				$worksheet1->write_string($baris,$kolom,'Rp. '.number_format($tarifKamarBayi,2,',','.'),$frmtRightBorder); $kolom++;
				$worksheet1->merge_cells($baris, 0, $baris, 2); 
				$worksheet1->merge_cells($baris, 3, $baris, 4); 
				$baris++; $kolom = 0;
			}
