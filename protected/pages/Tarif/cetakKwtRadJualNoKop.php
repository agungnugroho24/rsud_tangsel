<?php
class cetakKwtRadJualNoKop extends SimakConf
{
	...
	{	
		...
		*/
		...
		$pdf->Cell(0,5,'KUITANSI PEMBAYARAN RADIOLOGI','0',0,'C');
		$pdf->Ln(7);		
		...
		$text="Uang sebesar ".$sayTerbilang." untuk pembayaran Tindakan Radiologi dengan rincian terlampir.";
		...
		$pdf->Cell(130,8,'',0,0,'L');	
		$pdf->Cell(60,8,'( '.$operator.' )',0,0,'C','',$this->Service->constructUrl('Tarif.KasirRad') . '&purge=1');		
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',9);
		$pdf->Cell(130,8,'',0,0,'L');	
