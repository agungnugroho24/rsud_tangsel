<?php
class BayarKasirRwtJlnDiscountAsuransiJamperNonActive extends SimakConf
{   
	...
	public function checkNoTrans()
    {
		...
		{	
			...
			else
			{
				...
				if($kelompokPasien == '02' || $kelompokPasien == '07')//Kelompok Penjamin Asuransi 
				{
		...
		if($this->page->IsValid)
		{
			...
			else
			{
				...
				*/
				...
				$this->sisaByrTxt2->Text = 'Kekurangan Pembayaran (NonValue)';	
		...
		else//2x pembayaran
		{
			if($this->getViewState('stPiutang') != '1')//2x pembayaran dalam 1 waktu
			{
				...
				if($this->getViewState('stBayar2') == '1')
				{
					...
					//jika dalam pembyaran kedua masih ada kekurangan sisa bayar => INSERT tbt_kasir_rwtjln_angsuran yg st = 5 (NON VALUE)
