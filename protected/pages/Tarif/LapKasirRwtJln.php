<?php
class LapKasirRwtJln extends SimakConf
{   
	/**
	...
	*/
	protected function getDataRows($offset,$rows,$order,$sort,$pil,$cariNama,$cariCM,$urutBy,$tipeCari,$Company,$cariTgl,$cariBln,$cariByDokter,$cariByKlinik)
	{
		if($pil == "1")
		{ /*
			$sql = "SELECT a.cm,
						   ...
						   WHERE
								...
								AND g.id=e.dokter
								AND a.kelompok=b.id									
								AND a.kabupaten=c.id "; tbm_perusahaan e,
                  */
                        $sql = "SELECT a.cm AS cm,
									...
									AND a.cm=c.cm
									AND b.id_tindakan=d.id
									AND g.id=a.dokter
									AND f.id=a.id_klinik
									AND c.kelompok=h.id
									AND c.kabupaten=i.id
					";
			//$sql="select a.cm, a.no_trans from tbt_rawat_jalan a, tbt_kasir_rwtjln b where cm=".'000002'." AND a.no_trans=b.no_trans ";
			if($cariNama <> '')			
				if($tipeCari === true){
					$sql .= "AND c.nama LIKE '%$cariNama%' ";
				}
				else
				{	
					$sql .= "AND c.nama LIKE '$cariNama%' ";
			...
			if($cariByDokter <> '')			
				$sql .= "AND a.dokter = '$cariByDokter' ";
			
			if($cariByKlinik <> '')			
				$sql .= "AND a.id_klinik = '$cariByKlinik' ";		
			
			if($urutBy <> '')
				$sql .= "AND c.kelompok = '$urutBy' ";	
			
			if($Company <> '')
				$sql .= "AND c.perusahaan = '$Company' AND e.id_kel = '$urutBy'";
			
			if($cariTgl <> '')
			{
				$tgl = $this->ConvertDate($cariTgl,'2');//Convert date to mysql
				$sql .= "AND a.tgl_visit = '$tgl' ";
			}	
			...
			if($cariBln <> '')
			{
				...
				$sql .= "AND a.tgl_visit BETWEEN '$blnAwal' AND '$blnAkhir' ";		
			}	
    ...
    */   
	...
	{				
		...
		{	
			...
			//$this->UserGrid->DataSource=$page=PasienRecord::finder()->findAllBySql($this->getDataRows($offset,$limit,$orderBy,'','2',$cariByNama,$cariByCM,$urutBy,$elemenBy,$companyBy,$cariByTgl,$cariByBulan,$cariByDokter,$cariByKlinik));
            // $this->UserGrid->DataSource=$page=RwtjlnRecord::finder()->findAllBySql($this->getDataRows($offset,$limit,$orderBy,'','2',$cariByNama,$cariByCM,$urutBy,$elemenBy,$companyBy,$cariByTgl,$cariByBulan,$cariByDokter,$cariByKlinik));
			$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','2',$cariByNama,$cariByCM,$urutBy,$elemenBy,$companyBy,$cariByTgl,$cariByBulan,$cariByDokter,$cariByKlinik);			
	...
	{		
		...
		//$this->UserGrid->DataSource=$page=PasienRecord::finder()->findAllBySql($this->getDataRows($offset,$limit,$orderBy,'','1',$cariByNama,$cariByCM,$urutBy,$elemenBy,$companyBy,$cariByTgl,$cariByBulan,$cariByDokter,$cariByKlinik));
                $this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','1',$cariByNama,$cariByCM,$urutBy,$elemenBy,$companyBy,$cariByTgl,$cariByBulan,$cariByDokter,$cariByKlinik);
		$this->UserGrid->dataBind();		
	} 
	...
	public function useNumericPager($sender,$param)
	{
		...
		//$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','2',$cariByNama,$cariByCM,$urutBy,$elemenBy,$companyBy,$cariByAlamat,$cariByTgl,$cariByBulan,$cariByDokter,$cariByKlinik);
		//$this->UserGrid->DataSource=$page=PasienRecord::finder()->findAllBySql($this->getDataRows($offset,$limit,$orderBy,'','2',$cariByNama,$cariByCM,$rutBy,$elemenBy,$companyBy,$cariByTgl,$cariByBulan,$cariByDokter,$cariByKlinik));
                $this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','2',$cariByNama,$cariByCM,$rutBy,$elemenBy,$companyBy,$cariByTgl,$cariByBulan,$cariByDokter,$cariByKlinik);
		$this->UserGrid->dataBind();
	}	
	...
	{	
		...
		/*
		$arr=$this->queryAction($this->getDataRows($offset,$limit,$orderBy,'','1',$this->cariNama->Text,$this->cariCM->Text,$this->DDUrut->SelectedValue,$this->Advance->Checked,$this->DDKontrak->SelectedValue,$this->tglMsk->Text,$this->DDBulan->SelectedValue,$this->DDDokter->SelectedValue,$this->DDKlinik->SelectedValue),'R');
		$i=0;
			foreach($arr as $row)
			{
				$i=$i+1;
		...
		//$this->UserGrid->DataSource=$page=PasienRecord::finder()->findAllBySql($this->getDataRows($offset,$limit,$orderBy,'','1',$this->cariNama->Text,$this->cariCM->Text,$this->DDUrut->SelectedValue,$this->Advance->Checked,$this->DDKontrak->SelectedValue,$this->tglMsk->Text,$this->DDBulan->SelectedValue,$this->DDDokter->SelectedValue,$this->DDKlinik->SelectedValue));
                $this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','1',$this->cariNama->Text,$this->cariCM->Text,$this->DDUrut->SelectedValue,$this->Advance->Checked,$this->DDKontrak->SelectedValue,$this->tglMsk->Text,$this->DDBulan->SelectedValue,$this->DDDokter->SelectedValue,$this->DDKlinik->SelectedValue);
