...
class cetakKartuStatusIgd extends SimakConf
{
	...
	{					
		...
		$pdf->Cell(7,5,'',0,0,'L');	/*sisi kiri */
		$pdf->Cell(2,25,$date,0,0,'L','',$url);
		$pdf->Cell(148,5,'',0,0,'L');
		
		$pdf->SetFont('Arial','B',15);		
		$pdf->Cell(20,30,$cm1.' '.$cm2.' '.$cm3,0,0,'L');
		$pdf->Ln(2);
		
		$pdf->SetFont('Arial','',9);	
		$pdf->Cell(7,5,'',0,0,'L');	
		$pdf->Cell(2,30,$time.' WIB',0,0,'L');
		...
		$pdf->Cell(32,5,'',0,0,'L');
		$pdf->Cell(2,30,$nmPas,0,0,'L');		
		$pdf->Cell(115,5,'',0,0,'L');
		$pdf->Cell(2,30,$jkel,0,0,'L');
		$pdf->Ln(7.5);
		
		$pdf->Cell(32,5,'',0,0,'L');
		$pdf->Cell(2,30,$umur,0,0,'L');
		$pdf->Cell(115,5,'',0,0,'L');
		$pdf->Cell(2,30,$penanggung,0,0,'L');		
		$pdf->Ln(7.5);
		
		$pdf->Cell(32,5,'',0,0,'L');
		$pdf->Cell(2,30,$alamat,0,0,'L');
		$pdf->Ln(7.5);
		
		$pdf->Cell(32,5,'',0,0,'L');
		$pdf->Cell(2,30,$pekerjaan,0,0,'L');
		$pdf->Cell(115,5,'',0,0,'L');
		$pdf->Cell(2,30,$penjamin,0,0,'L');		
		$pdf->Ln(199);
