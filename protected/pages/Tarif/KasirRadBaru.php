<?php
class KasirRadBaru extends SimakConf
{   
	...
	*/
    ...
    {	
		...
		$this->Response->redirect($this->Service->constructUrl('Tarif.cetakNotaRad',array('notrans'=>$notrans,'cm'=>$cm,'nama'=>$nama,'jmlTagihan'=>$jmlTagihan,'jnsRujukan'=>$jnsRujukan,'asalPasien'=>$asalPasien,'petugasRad'=>$this->getViewState('petugasRad'))));
