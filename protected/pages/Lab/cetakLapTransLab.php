<?php
class cetakLapTransLab extends SimakConf
{
	...
	{		
		...
		$operatorLab=$this->Request['operatorLab'];
		...
		$pdf->Cell(0,5,'LAPORAN TRANSAKSI LABORATORIUM','0',0,'C','',$this->Service->constructUrl('Lab.LapTrans'));	
