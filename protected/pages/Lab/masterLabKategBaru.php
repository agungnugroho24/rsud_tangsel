 ...
 * @license http://www.intergo.co.id/license/
 */
class masterLabKategBaru extends SimakConf
{
	...
	public function checkRM($sender,$param)
    {
        ...
        $param->IsValid=(LabKategRecord::finder()->findByPk($this->ID->Text)===null);		
    }	   
	...
	public function simpanClicked()
	{
		if($this->IsValid)
		{
			$newKelPasien=new LabKategRecord();
			
			$newKelPasien->kode=$this->ID->Text;			
			$newKelPasien->jenis=$this->nama->Text;
