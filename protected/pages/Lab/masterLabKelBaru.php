 ...
 * @license http://www.intergo.co.id/license/
 */
class masterLabKelBaru extends SimakConf
{
	...
	public function checkRM($sender,$param)
    {
        ...
        $param->IsValid=(LabKelRecord::finder()->findByPk($this->ID->Text)===null);		
    }	   
	...
	public function simpanClicked()
	{
		if($this->IsValid)
		{
			$newKelPasien=new LabKelRecord();
			
			$newKelPasien->kode=$this->ID->Text;			
			$newKelPasien->nama=$this->nama->Text;
