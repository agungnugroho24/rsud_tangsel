<?php
class tarifLab extends SimakConf
{   
	/**
    ...
    */
    ...
    {       
		if ($this->User->IsAdmin)
		{
			...
			$tarifRcd = LabTarifRecord::finder()->findByPk($ID);
	...
	{		
		$this->Response->redirect($this->Service->constructUrl('Lab.tarifLabBaru'));		
	}
