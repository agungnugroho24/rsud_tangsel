<?php
class DataPasDetail2 extends SimakConf
{
	...
	public function cetakClicked($sender,$param)
    {
		...
		<script type="text/javascript">
			window.parent.location="index.php?page=Billing.CetakPembayaran&idMeja='.$idMeja.'&idSewaMeja='.$idSewaMeja.'&jmlBayar='.$jmlBayar.'&kembalian='.$kembalian.'"; window.close();
		</script>';	
		$this->msgError->Text = '';
