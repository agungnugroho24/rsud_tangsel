<?php
class kunjPasIgd extends SimakConf
{   
	/**
	...
	*/
	protected function getDataRows($offset,$rows,$order,$sort,$pil,$cariTgl,$cariBln,$cariByDokter)
	{
		...
		$page=IgdRecord::finder()->findAllBySql($sql);
    ...
    */   
	...
	{				
		...
		{					
			...
			$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','2',$cariByTgl,$cariByBulan,$cariByDokter);
	...
	{		
		...
		$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','1',$cariByTgl,$cariByBulan,$cariByDokter);
		$this->UserGrid->dataBind();		
	} 
	...
	{		
		...
		$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','1',$this->tglMsk->Text,$this->DDBulan->SelectedValue,$this->DDDokter->SelectedValue);	
		$this->UserGrid->dataBind();
	}
}
?>
