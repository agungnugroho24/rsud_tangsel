 ...
 * @license http://www.intergo.co.id/license/
 */
class CaraMasukPasienBaru extends SimakConf
{
	...
	public function checkRM($sender,$param)
    {
        ...
        $param->IsValid=(caramasukRecord::finder()->findByPk($this->ID->Text)===null);		
    }	   
	...
	public function simpanClicked()
	{
		if($this->IsValid)
		{
			$newCaraMasuk=new caramasukRecord();
			
			$newCaraMasuk->id=$this->ID->Text;			
			$newCaraMasuk->nama=$this->nama->Text;
