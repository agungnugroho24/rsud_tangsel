<?php
class DaftarCariRwtJlnPdf extends SimakConf
{   
	...
	{	
		...
		*/
		...
		if($jmlData!=0)
		{
			...
			$pdf->Cell(0,5,'HASIL PENCARIAN DATA PASIEN RAWAT JALAN','0',0,'C','',$this->Service->constructUrl('Pendaftaran.DaftarCariRwtJln'));			
			...
			$pdf->Cell(30,10,'Poliklinik','1',0,'C');
			...
			foreach($arrData as $row)
			{
				...
				$y=$pdf->GetY();
				$x=$pdf->GetX();
				$pdf->MultiCell(30,10,$row['klinik'],'1','C');
		...
		else
		{
			...
			$pdf->Cell(0,5,'DATA PASIEN RAWAT JALAN TIDAK DITEMUKAN','0',0,'C','',$this->Service->constructUrl('Pendaftaran.DaftarCariRwtJln'));			
			$pdf->Ln(7);
		}
