...
class AdminRwtJln extends SimakConf
{
    ...
    public function getDummyData($token){
                $sql = "SELECT nama FROM tbm_obat WHERE tbm_obat.kategori = '01' AND tbm_obat.nama LIKE '$token%' GROUP BY tbm_obat.kode ORDER BY tbm_obat.nama ASC "; 
                $arr = $this->queryAction($sql,'S');
		return $arr;
    }
    ...
    /*
     *  @function untuk membedakan apakah racikan atau bukan dan menentukan racikan ke berapa
     *  @param $sender-> , $param ->
     *  made by PT. GSK @November 2013
     */
    ...
    /*
     *  @function untuk mengaktifkan tombol kemasan dan jumlah kemasan apabila obat adalah obat racikan
     *  @param $sender-> , $param ->
     *  made by PT. GSK @November 2013
     */    
    public function DDRacikChanged($sender,$param)
	{
        ...
        /*
         *  @function untuk mengecek obat yang ditambahkan di dalam resep
         *  @param $sender-> , $param ->
         *  made by PT. GSK @November 2013
         */
        public function checkTambahkan($sender, $param)
        {
            ...
            // Validasi apabila sebuah racikan
            ...
            // -- validasi jika nama obatnya kosong --
            if( $namaobat == '' )
            {
                $this->getPage()->getClientScript()->registerEndScript
            ...
            // -- Validasi jika tidak ada yang dipilih dari radio buttonnya
            else if( $tipeObat == '' )
            {
                $this->getPage()->getClientScript()->registerEndScript
            ...
            // -- Validasi jika bukan sebuah number, return true, akan masuk ke if
            ...
            // -- Validasi jika jumlah obat 0 atau minus
            ...
            else
            {
                ...
                else
                {
                    ...
                    $sql = "INSERT INTO
                        ...
                        VALUES( '".$kodeObat."', '".$namaobat."', '1', '".$tipeObat."', '01' )
                    ";
        ...
        /*
         *  @function untuk menambahkan obat di dalam resep
         *  @param $sender-> , $param ->
         *  made by PT. GSK @November 2013
         */
        ...
        /*
         *  @function untuk menghapus obat dalam resep
         *  @param $sender-> , $param ->
         *  made by PT. GSK @November 2013
         */       
        ...
        /*
         *  @function untuk menghapus obat dalam resep, lanjutan dari fungsi deleteItem
         *  @param $sender-> , $param ->
         *  made by PT. GSK @November 2013
         */
  ...
  {	
	...
	/*public function cetakClicked($sender,$param)
        ...
        /*
         *  @function untuk menyimpan data rawat jalan pasien (memperluas fungsi agar bisa menyimpan resep pasien)
         *  @param $sender-> , $param ->
         *  modified by PT. GSK @November 2013
         */ 	
