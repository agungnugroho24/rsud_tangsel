...
class List extends TPage
{
    private $sortExp = "Col1";
    private $sortDir = "ASC";
    private $offset = 0;
    private $pageSize = 10;
    ...
    private function bindGrid()
    {
        ...
        if (!$session->contains("SomeData")) 
        {
            ...
            $data = $someDataList->getSomeDataPage();
            $this->dtgSomeData->VirtualItemCount = $someDataList->getSomeDataCount();
    ...
    protected function dtgSomeData_UpdateCommand($sender,$param)
    {
        ...
        if ( doSomeValidation() )
		{
            ...
            $oSomeData = SomeDataList::getSomeData($this->dtgSomeData->DataKeys[$item->ItemIndex]);
