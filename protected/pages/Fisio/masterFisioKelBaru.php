...
class masterFisioKelBaru extends SimakConf
{
	...
	public function checkRM($sender,$param)
    {
        ...
        $param->IsValid=(FisioKelRecord::finder()->findByPk($this->ID->Text)===null);		
    }	   
	...
	public function simpanClicked()
	{
		if($this->IsValid)
		{
			...
			{
				//INSERT tbm_fisio_kelompok
				$newFisioKel=new FisioKelRecord();		
				$newFisioKel->nama = strtoupper($this->nama->Text);
				$newFisioKel->save();		
