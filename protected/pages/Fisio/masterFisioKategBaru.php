...
class masterFisioKategBaru extends SimakConf
{
	...
	public function checkRM($sender,$param)
    {
        ...
        $param->IsValid=(FisioKategRecord::finder()->findByPk($this->ID->Text)===null);		
    }	   
	...
	public function simpanClicked()
	{
		if($this->IsValid)
		{
			...
			$sql = "SELECT jenis FROM tbm_fisio_kategori WHERE LOWER(jenis) = '$nama' ";
			...
			{
				//INSERT tbm_fisio_kategori
				$newFisioKel=new FisioKategRecord();		
				$newFisioKel->jenis = ucwords($this->nama->Text);
				$newFisioKel->save();		
