<?php
class masterFisioRujukan extends SimakConf
{   
	/**
	...
	*/
	protected function getDataRows($offset,$rows,$order,$sort,$pil,$cariNama,$cariID,$tipeCari)
	{
		...
		$page=FisioRujukanRecord::finder()->findAllBySql($sql);
    ...
    */   
	...
	{				
		...
		{					
			...
			$this->UserGrid->VirtualItemCount=FisioRujukanRecord::finder()->count();
    ...
    public function deleteButtonClicked($sender,$param)
    {
        if ($this->User->IsAdmin)
		{
			...
			FisioRujukanRecord::finder()->deleteByPk($ID);	
	...
	{		
		$this->Response->redirect($this->Service->constructUrl('Fisio.masterFisioRujukanBaru'));		
	}
