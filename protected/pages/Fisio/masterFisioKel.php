<?php
class masterFisioKel extends SimakConf
{   
	/**
	...
	*/
	protected function getDataRows($offset,$rows,$order,$sort,$pil,$cariNama,$cariID,$tipeCari)
	{
		...
		$page=FisioKelRecord::finder()->findAllBySql($sql);
    ...
    */   
	...
	{				
		...
		{					
			...
			$this->UserGrid->VirtualItemCount=FisioKelRecord::finder()->count();
    ...
    public function deleteButtonClicked($sender,$param)
    {
        if ($this->User->IsAdmin)
		{
			...
			FisioKelRecord::finder()->deleteByPk($ID);	
	...
	{		
		$this->Response->redirect($this->Service->constructUrl('Fisio.masterFisioKelBaru'));		
	}
