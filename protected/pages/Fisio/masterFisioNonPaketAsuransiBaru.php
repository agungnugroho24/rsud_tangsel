...
class masterFisioNonPaketAsuransiBaru extends SimakConf
{
			...
			{*/
				...
				if($this->getViewState('nmTable'))
				{
					...
					*/
					...
					$this->getPage()->getClientScript()->registerEndScript
					('','unmaskContent();
						jQuery.WsGrowl.show({title: \'\', content:\'<p class="msg_question">Penambahan tindakan Elektromedik asuransi sukses telah ditambahkan dalam database. <br/><br/> Apakah akan menambah tindakan baru lagi ?</p>\',timeout: 600000,dialog:{
							modal: true,
							buttons: {
								"Ya": function() {
