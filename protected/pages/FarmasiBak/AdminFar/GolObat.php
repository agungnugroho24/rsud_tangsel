<?php
class GolObat extends SimakConf
{   
	...
	*/
	protected function getDataRows($offset,$rows,$order,$sort,$pil,$cariNama,$cariID,$tipeCari)
	{
		...
		$page=GolObatRecord::finder()->findAllBySql($sql);
    ...
    */   
    ...
    public function deleteButtonClicked($sender,$param)
    {
        if ($this->User->IsAdmin)
		{
			...
			GolObatRecord::finder()->deleteByPk($ID);	
	...
	{		
		$this->Response->redirect($this->Service->constructUrl('Farmasi.AdminFar.GolObatBaru'));		
	}
