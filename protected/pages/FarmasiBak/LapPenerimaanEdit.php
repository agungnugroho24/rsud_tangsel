<?php
class LapPenerimaanEdit extends SimakConf
{  	
	...
	*/
    ...
    private function bindGrid()
    {
        ...
        if (!$session->contains("SomeData")) 
        {
           ...
           //$sql = "SELECT * FROM view_penerimaan_obat_edit WHERE kode <> ''";				
		   $sql = "SELECT * FROM tbt_obat_masuk WHERE id_obat <> ''";				
		  			
			if($this->noPo->Text != '')	
			{			
				$cariByPo = $this->noPo->Text;				
				$sql .= "AND no_po LIKE '%$cariByPo%' ";
			}
			/*			   
    ...
    */
    ...
    {	
		...
		$this->Response->redirect($this->Service->constructUrl('Farmasi.ObatMasukEdit',array('noPO'=>$noPo)));		
	}
