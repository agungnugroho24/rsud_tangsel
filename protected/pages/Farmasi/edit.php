...
{   
	...
	*/
	...
	protected function getDataRows($offset,$rows,$order,$sort,$pil,$cariNama,$cariID,$tipeCari,$cariGol,$cariKlas,$cariDerivat,$cariPbf,$cariProd,$cariSat,$sumber,$tujuan)
	{
		if($pil == "1")
		{
			...
			if($tujuan <> '')
			{
				$sql.="tbt_stock_lain b ";
			}else{
				$sql.= " tbt_stok_gudang b ";
			}			
    ...
    */
	...
	{				
		...
		{	
			...
			$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','2',$cariByNama,$cariByID,$elemenBy,$cariByGol,$cariByKlas,$cariByDerivat,$cariByPbf,$cariByProd,$cariBySat,$sumber,$tujuan);
	...
	{		
		...
		$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','1',$cariByNama,$cariByID,$elemenBy,$cariByGol,$cariByKlas,$cariByDerivat,$cariByPbf,$cariByProd,$cariBySat,$sumber,$tujuan);
		$this->UserGrid->dataBind();		
	} 
	...
	{		
		...
		$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','1',$this->cariNama->Text,$this->ID->Text,$this->Advance->Checked,$this->DDGol->SelectedValue,$this->DDKlas->SelectedValue,$this->DDDerivat->SelectedValue,$this->DDPbf->SelectedValue,$this->DDProd->SelectedValue,$this->DDSat->SelectedValue,$sumber,$tujuan);
		$this->UserGrid->dataBind();	
	}
	...
	{		
		...
		$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','1',$this->cariNama->Text,$this->ID->Text,$this->Advance->Checked,$this->DDGol->SelectedValue,$this->DDKlas->SelectedValue,$this->DDDerivat->SelectedValue,$this->DDPbf->SelectedValue,$this->DDProd->SelectedValue,$this->DDSat->SelectedValue,$sumber,$this->DDTujuan->SelectedValue);	
		$this->UserGrid->dataBind();
	}
