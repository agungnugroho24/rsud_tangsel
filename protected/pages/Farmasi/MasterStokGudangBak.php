<?php
class MasterStokGudangBak extends SimakConf
{   
	/**
	...
	*/
	...
	protected function getDataRows($offset,$rows,$order,$sort,$pil,$cariNama,$cariID,$tipeCari,$cariGol,$cariKlas,$cariDerivat,$cariPbf,$cariProd,$cariSat,$sumber)
	{
		...
		$this->showSql->Visible=true;//show SQL Expression broer!
		return $page;
    ...
    */
	...
	public function itemCreated($sender,$param)
    {
        ...
        if($item->ItemType==='Item' || $item->ItemType==='AlternatingItem' || $item->ItemType==='DeleteItem' || $item->ItemType==='EditItem')
        {
