<?php
class MasterStokGudang3 extends SimakConf
{   	
        ...
        if (!$session->contains("SomeData")) 
        {
			...
			*/
			...
			$sql = "SELECT *, 
					  ...
					  sum(if((view_stok_gudang.tujuan = '4'), view_stok_gudang.jumlah, 0)) AS stok_icu,
					  ...
					  sum(if((view_stok_gudang.tujuan = '8'), view_stok_gudang.jumlah, 0)) AS stok_poli_anak,
					  sum(if((view_stok_gudang.tujuan = '9'), view_stok_gudang.jumlah, 0)) AS stok_poli_kandungan,
					  sum(if((view_stok_gudang.tujuan = '10'), view_stok_gudang.jumlah, 0)) AS stok_ruang_bayi,
					  sum(if((view_stok_gudang.tujuan = '11'), view_stok_gudang.jumlah, 0)) AS stok_fisiotherapi,
					...
					FROM
					  view_stok_gudang 
					WHERE
						view_stok_gudang.tujuan = '$tujuan' ";				
			...
			*/
			...
			$sql .= " GROUP BY
					  view_stok_gudang.id_harga,view_stok_gudang.kode ";			
