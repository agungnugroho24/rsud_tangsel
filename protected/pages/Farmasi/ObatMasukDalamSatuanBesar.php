<?php
class ObatMasukDalamSatuanBesar extends SimakConf
{ 
	...
	public function ambilDataObatBeli($noPO)
	{
		if($this->modeTerima->SelectedValue == '0')//penerimaan baru
		{
			$sql = "SELECT * FROM tbt_obat_beli WHERE no_po='$noPO' AND flag='0' ";
		}
		elseif($this->modeTerima->SelectedValue == '1')//penerimaan tunda
		{
			$sql = "SELECT * FROM tbt_obat_beli_tunda WHERE no_po='$noPO' AND flag='0' ";
		}
