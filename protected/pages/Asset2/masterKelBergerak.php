<?php
class masterKelBergerak extends SimakConf
{   
    ...
    */   
    ...
    public function deleteButtonClicked($sender,$param)
    {
        if ($this->User->IsAdmin)
		{
			...
			AssetKelBergerakRecord::finder()->deleteByPk($ID);	
	...
	{		
		$this->Response->redirect($this->Service->constructUrl('Asset.masterKelBergerakBaru'));		
	}
