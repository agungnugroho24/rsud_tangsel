<?php
class masterDist extends SimakConf
{   
    ...
    */   
    ...
    public function deleteButtonClicked($sender,$param)
    {
        if ($this->User->IsAdmin)
		{
			...
			AssetDistributorRecord::finder()->deleteByPk($ID);	
	...
	{		
		$this->Response->redirect($this->Service->constructUrl('Asset.masterDistBaru'));		
	}
