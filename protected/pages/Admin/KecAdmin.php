<?php
class KecAdmin extends SimakConf
{   
	...
	public function gridEditClicked($sender,$param)
	{
		...
		$this->Response->redirect($this->Service->constructUrl('Admin.KecEdit',array('ID'=>$ID)));
		/*
	...
	public function gridHapusClicked($sender,$param)
	{
		...
		$sql = "DELETE FROM tbm_kecamatan WHERE id='$ID'";
	...
	{	
		$this->Response->redirect($this->Service->constructUrl('Admin.KecBaru'));		
	}
