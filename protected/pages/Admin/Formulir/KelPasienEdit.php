<?php
class KelPasienEdit extends SimakConf
{
	...
	public function onPreLoad($param)
	{
		...
		if(!$this->IsPostBack)  // if the page is initially requested
		{
            ...
            $this->ID->Text=$KelurahanRecord->id;
	...
	public function simpanClicked($sender,$param)	{			
		...
		if($this->IsValid)  // when all validations succeed
        {
           ...
           // $temp=$this->Request['ID'];
            ...
            $KelurahanRecord->id=ucwords($this->ID->Text);
	...
	*/
	...
	protected function getKelPasRecord()
	{
		...
		$KelPasRecord=KelompokRecord::finder()->findByPk($ID);		
		if(!($KelPasRecord instanceof KelompokRecord))
