<?php
class KelPasien extends SimakConf
{   
	/**
	...
	*/
	protected function getDataRows($offset,$rows,$order,$sort,$pil,$cariNama,$cariID,$tipeCari)
	{
		...
		$page=KelompokRecord::finder()->findAllBySql($sql);
    ...
    */   
    ...
    public function deleteButtonClicked($sender,$param)
    {
        if ($this->User->IsAdmin)
		{
			...
			KelompokRecord::finder()->deleteByPk($ID);	
	...
	{		
		$this->Response->redirect($this->Service->constructUrl('Admin.Formulir.KelPasienBaru'));		
	}
