 ...
 * @license http://www.intergo.co.id/license/
 */
class KelPasienBaru extends SimakConf
{
	...
	public function checkRM($sender,$param)
    {
        ...
        $param->IsValid=(KelompokRecord::finder()->findByPk($this->ID->Text)===null);		
    }	   
	...
	public function simpanClicked()
	{
		if($this->IsValid)
		{
			$newKelPasien=new KelompokRecord();
			
			$newKelPasien->id=$this->ID->Text;			
