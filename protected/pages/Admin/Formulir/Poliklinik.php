<?php
class Poliklinik extends SimakConf
{   
	/**
	...
	*/
	protected function getDataRows($offset,$rows,$order,$sort,$pil,$cariNama,$cariID,$tipeCari)
	{
		...
		$page=PoliklinikRecord::finder()->findAllBySql($sql);
    ...
    */   
	...
	{				
		...
		{					
			...
			$this->UserGrid->VirtualItemCount=PoliklinikRecord::finder()->count();
    ...
    public function deleteButtonClicked($sender,$param)
    {
        if ($this->User->IsAdmin)
		{
			...
			PoliklinikRecord::finder()->deleteByPk($ID);	
	...
	{		
		$this->Response->redirect($this->Service->constructUrl('Admin.Formulir.PoliklinikBaru'));		
	}
