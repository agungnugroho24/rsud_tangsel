 ...
 * @license http://www.intergo.co.id/license/
 */
class PddkPasienBaru extends SimakConf
{
	...
	public function checkRM($sender,$param)
    {
        ...
        $param->IsValid=(PendidikanRecord::finder()->findByPk($this->ID->Text)===null);		
    }	   
	...
	public function simpanClicked()
	{
		if($this->IsValid)
		{
			$newPendidikan=new PendidikanRecord();
			
			$newPendidikan->id=$this->ID->Text;			
			$newPendidikan->nama=$this->nama->Text;
