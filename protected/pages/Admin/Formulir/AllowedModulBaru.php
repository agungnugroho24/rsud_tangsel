 ...
 * @license http://www.intergo.co.id/license/
 */
class AllowedModulBaru extends SimakConf
{
	...
	public function checkRM($sender,$param)
    {
        ...
        $param->IsValid=(AllowRecord::finder()->findByPk($this->ID->Text)===null);		
    }	   
	...
	public function simpanClicked()
	{
		if($this->IsValid)
		{
			$newAllowedModul=new AllowRecord();
			
			$newAllowedModul->id=$this->ID->Text;			
			$newAllowedModul->nama=$this->nama->Text;
			
			$newAllowedModul->save();				
