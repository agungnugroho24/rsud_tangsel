<?php
class lapSimpeg extends SimakConf
{   
	/**
    ...
    */   
	...
	{		
		...
		$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','1',$this->cariNama->Text,$this->cariNip->Text,$DDUrut,$this->Advance->Checked);	
		$this->UserGrid->dataBind();
	}
