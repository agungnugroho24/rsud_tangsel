<?php
class terimaFarmasi extends SimakConf
{   
	/**
    ...
    */   
	...
	{		
		...
		$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','1',$cariNama,$cariCM,$this->DDUrut->SelectedValue,$Advance,$this->DDKontrak->SelectedValue,$cariAlamat,$this->tglMsk->Text,$this->DDBulan->SelectedValue,$this->DDDokter->SelectedValue,$this->DDKlinik->SelectedValue);	
		$this->UserGrid->dataBind();
	}
	...
	{				
		...
		$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','1',$cariNama,$cariCM,$this->DDUrut->SelectedValue,$Advance,$this->DDKontrak->SelectedValue,$this->cariAlamat->Text,$this->tglMsk->Text,$this->DDBulan->SelectedValue,$this->DDDokter->SelectedValue,$this->DDKlinik->SelectedValue);	
		$this->UserGrid->dataBind();
	}
}
?>
