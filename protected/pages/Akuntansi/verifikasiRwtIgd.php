<?php
class verifikasiRwtIgd extends SimakConf
{   
	/**
    ...
    */   
	...
	{		
		...
		$this->UserGrid->DataSource=$this->getDataRows($offset,$limit,$orderBy,'','1',$cariNama,$cariCM,$this->DDUrut->SelectedValue,$Advance,$this->DDKontrak->SelectedValue,$cariAlamat,$this->tglMsk->Text,$this->DDBulan->SelectedValue,$this->DDDokter->SelectedValue,$DDKlinik);	
		$this->UserGrid->dataBind();
	}
