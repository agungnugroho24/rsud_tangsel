...
class masterRadKelEdit extends SimakConf
{
	...
	public function onPreLoad($param)
	{
		...
		{
			$KelurahanRecord = $this->RadKelRecord;	
	...
	*/
	...
	protected function getRadKelRecord()
	{
		// use Active Record to look for the specified username
		$ID=$this->Request['ID'];
		$this->setViewState('ID',$ID);
		$RadKelRecord=RadKelRecord::finder()->findByPk($ID);		
		if(!($RadKelRecord instanceof RadKelRecord))
