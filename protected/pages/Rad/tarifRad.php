<?php
class tarifRad extends SimakConf
{   
	/**
    ...
    */
	...
	{				
		...
		{	
			...
			//$this->UserGrid->VirtualItemCount = RadTdkRecord::finder()->count();
    ...
    {       
		if ($this->User->IsAdmin)
		{
			...
			$tarifRcd = RadTarifRecord::finder()->findByPk($ID);
	...
	{		
		$this->Response->redirect($this->Service->constructUrl('Rad.tarifRadBaru'));		
	}
	...
	{		
		...
		$this->UserGrid->VirtualItemCount = count($this->getDataRows($offset,$limit,$orderBy,'','1',$this->cariNama->Text,$this->ID->Text,$this->Advance->Checked,$this->DDRadKateg->SelectedValue,$this->DDRadKel->SelectedValue));
	...
	{				
		...
		$this->UserGrid->VirtualItemCount = count($this->getDataRows($offset,$limit,$orderBy,'','2',$this->cariNama->Text,$this->ID->Text,$this->Advance->Checked,$this->DDRadKateg->SelectedValue,$this->DDRadKel->SelectedValue));
