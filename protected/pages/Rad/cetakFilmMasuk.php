...
class cetakFilmMasuk extends SimakConf
{
	...
	{	
		...
		*/
		...
		$pdf->Cell(65,8,'( Direktur )',0,0,'C','',$this->Service->constructUrl('Rad.ObatBeli'));
		$pdf->Cell(65,8,'( Manajer Keuangan )',0,0,'C','',$this->Service->constructUrl('Rad.ObatBeli'));
		$pdf->Cell(60,8,'( '.$operator.' )',0,0,'C','',$this->Service->constructUrl('Rad.ObatBeli'));	
