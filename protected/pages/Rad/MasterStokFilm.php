...
{   	
	...
	public function cetakClicked($sender,$param)
	{
		...
		$this->Response->redirect($this->Service->constructUrl('Rad.cetakStokFilm',array('tujuan'=>$tujuan,'jnsBarang'=>$jnsBarang,'kelompokBarang'=>$kelompokBarang,'tipeCetak'=>$tipeCetak)));
	}
