...
{   
	...
	*/
	protected function getDataRows($offset,$rows,$order,$sort,$pil,$cariNama,$cariID,$tipeCari)
	{
		...
		$page=RadRujukanRecord::finder()->findAllBySql($sql);
    ...
    */   
	...
	{				
		...
		{					
			...
			$this->UserGrid->VirtualItemCount=RadRujukanRecord::finder()->count();
    ...
    public function deleteButtonClicked($sender,$param)
    {
        if ($this->User->IsAdmin)
		{
			...
			RadRujukanRecord::finder()->deleteByPk($ID);	
	...
	{		
		$this->Response->redirect($this->Service->constructUrl('Rad.masterRadRujukanBaru'));		
	}
