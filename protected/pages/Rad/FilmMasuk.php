...
{ 
	...
	public function cetakClicked($sender,$param)
    {
		...
		//$this->test->Text = $tes;
		$this->Response->redirect($this->Service->constructUrl('Rad.cetakFilmMasuk1',array('noPO'=>$noPO,'tgl'=>$tglFaktur,'noFak'=>$noFak,'mat'=>$cek,'ppn'=>$ppn,'pot'=>$pot,'modeTerima'=>$this->modeTerima->SelectedValue,'nmTable'=>$nmTable,'st_rkbu_rtbu'=>$st_rkbu_rtbu)));
	}
	...
	public function prevClicked($sender,$param)
    {
		...
		$this->queryAction($nmTable,'D');*/
		//$this->test->Text = $tes;
		$this->Response->redirect($this->Service->constructUrl('Rad.cetakFilmMasukEdit',array('noPO'=>$noPO,'tgl'=>$tglFaktur,'noFak'=>$noFak,'mat'=>$cek,'ppn'=>$ppn,'pot'=>$pot,'tab'=>$nmTable)));
	}	
}
?>
