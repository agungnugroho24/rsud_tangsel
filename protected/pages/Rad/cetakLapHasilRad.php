...
class cetakLapHasilRad extends SimakConf
{
	...
	{	
		...
		if($jnsPasien=='0')
		{
			...
			if($mode == '0')
				$sql .= "AND tbt_rad_penjualan.st_medical_checkup = '0' AND tbt_rad_penjualan.st_travel_clinic = '0' ";
			elseif($mode == '1')
				$sql .= "AND tbt_rad_penjualan.st_medical_checkup = '1' ";
			elseif($mode == '2')
				$sql .= "AND tbt_rad_penjualan.st_travel_clinic = '1' ";	
		}
		elseif($jnsPasien=='1')
		{
			$sql = "SELECT 
		...
		elseif($jnsPasien=='2')
		{
			...
			if($mode == '0')
				$sql .= "AND tbt_rad_penjualan_lain.st_medical_checkup = '0' AND tbt_rad_penjualan_lain.st_travel_clinic = '0' ";
			elseif($mode == '1')
				$sql .= "AND tbt_rad_penjualan_lain.st_medical_checkup = '1' ";
			elseif($mode == '2')
				$sql .= "AND tbt_rad_penjualan_lain.st_travel_clinic = '1' ";	
		}
		...
		foreach($arrData as $row)
		{
			...
			$url = $this->Service->constructUrl('Rad.beritaRad');
