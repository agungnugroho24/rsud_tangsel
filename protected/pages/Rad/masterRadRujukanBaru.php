...
class masterRadRujukanBaru extends SimakConf
{
	...
	public function checkRM($sender,$param)
    {
		...
		$data = count(RadRujukanRecord::finder()->findByPk($this->ID->Text));
		
		if($param->Value == ($data > 0))
            $param->IsValid=false;
			
       // $param->IsValid=(RadRujukanRecord::finder()->findByPk($this->ID->Text)===null);		
    }	   
	...
	public function simpanClicked()
	{
		if($this->IsValid)
		{
			$newPoliklinik=new RadRujukanRecord();
