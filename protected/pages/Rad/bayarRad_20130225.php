...
{   
    ...
    {		
		...
		$sql="INSERT INTO $nmTable (id_film,nm_film,nama,total,id_tdk,st_rujukan,id_rad_rujukan,id_paket_tdk_asuransi) VALUES ('$film','$nmFilm','$nama','$total','$item','$st_rujukan','$id_rad_rujukan','$idPaketTdkAsuransi')";
		$this->queryAction($sql,'C');//Insert new row in tabel bro...
