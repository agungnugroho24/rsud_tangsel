...
{   
    ...
    {			
		...
		$newInapVisite->tarif=$this->getViewState('tarif_visite');;
		$newInapVisite->Save();			
	...
	public function DDdokterChanged($sender,$param)
    {
		...
		if($this->DDdokter->SelectedValue != '')
		{
			...
			$this->setViewState('tarif_visite',$tarif_visite);
		}
		else
		{
			$this->clearViewState('tarif_visite');
		}
	}
