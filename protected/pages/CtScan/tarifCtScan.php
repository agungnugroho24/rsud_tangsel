<?php
class tarifCtScan extends SimakConf
{   
	/**
    ...
    */
	...
	{				
		...
		{	
			...
			//$this->UserGrid->VirtualItemCount = CtScanTdkRecord::finder()->count();
    ...
    {       
		if ($this->User->IsAdmin)
		{
			...
			$tarifRcd = CtScanTarifRecord::finder()->findByPk($ID);
