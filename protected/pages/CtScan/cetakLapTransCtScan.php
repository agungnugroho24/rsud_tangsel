<?php
class cetakLapTransCtScan extends SimakConf
{
	...
	{		
		...
		$pdf->Cell(0,5,'LAPORAN TRANSAKSI RADIOLOGI','0',0,'C','',$this->Service->constructUrl('CtScan.LapTrans'));	
		...
		*/			
		...
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',9);		
		$pdf->Cell(80,8,'Petugas CtScan.,',0,0,'C');	
		$pdf->Ln(15);	
		$pdf->SetFont('Arial','BU',9);	
		//$pdf->Cell(53,8,'('.$operator.')',0,0,'C','',$this->Service->constructUrl('Apotik.penjualanObat') . '&purge=1&nmTable=' . $nmTable);
		$pdf->Cell(80,8,'('.$operator.')',0,0,'C','',$this->Service->constructUrl('CtScan.LapTrans'));		
		$pdf->Ln(5);
		$pdf->SetFont('Arial','',9);	
