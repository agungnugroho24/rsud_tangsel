<?php
class bayarRadBaru extends SimakConf
{   
	...
	{				
		...
		{					
			...
			//$this->DDTdkRad->DataSource=CtScanTdkRecord::finder()->findAll();
			//$this->DDTdkRad->dataBind();
    ...
    {	
		...
		}elseif($jnsPasien == '1')
		{
			...
			$notransTmp = $this->numCounter('tbt_ctscan_penjualan_lain',LabJualLainRecord::finder(),'52');
			foreach($arrData as $row)
			{
