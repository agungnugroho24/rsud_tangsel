	...
	{	
		...
		*/
		...
		foreach($arrData1 as $row)
		{
			...
			//if($st_rkbu_rtbu == '0')
				$pdf->Cell(230,5,'TANDA TERIMA PENGADAAN BARANG RADIOLOGI','0',0,'C','',$this->Service->constructUrl('CtScan.FilmMasuk'));
			//elseif($st_rkbu_rtbu == '1')
				//$pdf->Cell(230,5,'TANDA TERIMA ASET RTBU/RTPBU','0',0,'C','',$this->Service->constructUrl('CtScan.FilmMasuk'));
