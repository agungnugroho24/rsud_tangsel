<?php
class KemasanObat extends SimakConf
{   
	...
	public function itemCreated($sender,$param)
    {
		...
		if($item->ItemType==='EditItem')
        {
		   ...
		   $item->nama->TextBox->Columns=30;
		   $item->hrg->TextBox->Columns=3;
        }       
	...
	public function saveItem($sender,$param)
    {
		...
		$update = KemasanRecord::finder()->findByPk($id);
		$update->nama = $item->nama->TextBox->Text; 
		$update->hrg = $item->hrg->TextBox->Text; 
