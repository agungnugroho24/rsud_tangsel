<?php
class cetakReturObatPasienFormBaru extends SimakConf
{
	...
	{			
		...
		$pdf->Cell(0,4,'RETUR OBAT RAWAT JALAN','0',0,'C');
		$pdf->Ln(4);	
		...
		$pdf->Cell(80,4,'Obat',1,0,'C');
		$pdf->Cell(30,4,'Harga',1,0,'C');
		$pdf->Cell(20,4,'Jumlah',1,0,'C');
		$pdf->Cell(35,4,'Total',1,0,'C');	
		*/	
		//Line break
		$pdf->Ln(5);
		...
		$pdf->Cell(50,4,'('.$operator.')',0,0,'C','',$this->Service->constructUrl('Apotik.returObatJalan') . '&purge=1');				
		$pdf->Ln(4);
		$pdf->SetFont('Arial','',7);	
