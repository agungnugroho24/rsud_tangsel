<?php
class cetakNotaObatKreditNoKop extends SimakConf
{
	...
	{	
		...
		*/
		...
		elseif($jnsPasien == '1')
		{
			$pdf->Cell(0,5,'RINCIAN PEMBELIAN OBAT/ALKES RAWAT INAP','0',0,'C');
		}
		elseif($jnsPasien == '2')
		{
		...
		foreach($arrData as $row)
		{
			...
			$pdf->Cell(80,5,ObatRecord::finder()->findByPk($row['id_obat'])->nama,1,0,'L');
